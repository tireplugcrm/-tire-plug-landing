...
export default function P() {
  return <ServicePage svc={{
    ...
    description: "Buy new tires in Los Angeles at The Tire Plug. Budget to premium brands (Goodyear, Falken, Michelin, Continental, Lexani), every size, expert install. Honest pricing, same-day, two LA locations. Call (562) 513-0217.",
