...
function addDaySheet(wb, day) {
  ...
  for (const r of day.rows) {
    const row = ws.addRow({
      ...
      tireC: r.tireCost, tpmsC: r.tpmsCost || "", oilC: r.oilCost || "", tcost: r.totalCost, retail: r.retail, tax: r.tax,
  ...
  const t = ws.addRow({
    ...
    tireC: day.tireCost, tpmsC: day.tpmsCost, oilC: day.oilCost, tcost: day.cogs,
