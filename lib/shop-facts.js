...
PHONE: 562-500-4625
LOCATION & HOURS:
  - The Tire Plug — Olympic: 2331 E Olympic Blvd, Los Angeles, CA 90021. Mon-Fri 9AM-7PM, Sat 9AM-6PM, Sun 10AM-4PM.
...
SAME-DAY: Same-day appointments are often available; for urgent needs, tell them to call 562-500-4625.
...
will send it shortly (or to call 562-500-4625).
`.trim();
...
export const FOLLOWUPS = [
  ...
  { minutes: 720, text: "Hi {name}, last check-in from The Tire Plug — your quote's still good. Reply here or call 562-500-4625 and we'll get you taken care of. Reply STOP to opt out." },
];
